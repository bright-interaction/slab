		...
		<Card padding="md">
			...
			<ol class="mt-4 list-decimal space-y-2 pl-5 text-[13px] text-text-secondary">
				...
				<li>
					...
					<span class="font-mono text-[12px]">&lt;slug&gt;.atomicsite.example.com</span> by
					default.
				</li>
			</ol>
		</Card>
