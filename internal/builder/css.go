...
// CanonicalShadowFormula is the tinted-shadow recipe slab uses
...
func BuildCSS(ctx context.Context, queries *store.Queries, siteID string) (string, error) {
	...
	b.WriteString("/* --- Slab baseline utilities --- */\n\n")
	...
	// block_type) when a specific customer needs one. Slab ships the
